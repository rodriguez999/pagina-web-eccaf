      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-center text-lg font-semibold text-foreground">
            Plaza Don Vicente, Primer piso, local 3B, ubicada en la Avenida República de Colombia, esq. valle primera entrada las flores, Distrito Municipal de Pantoja, Municipio los Alcarrizos, Provincia ssanto Domingo, República Dominicana.
          </p>
        </div>
      </div>
    </section>
